...
public class SolicitacaoCsvService {
    ...
    public String solicitacoesRelatorio() {
        ...
        String listaSolicitacoesRelatorio = solicitacoes
                .stream()
                .filter(solicitacao -> solicitacao.getStatus().equalsIgnoreCase(Solicitacao.Status.HOSPEDE.toString()) ||
                        solicitacao.getStatus().equalsIgnoreCase(Solicitacao.Status.EX_HOSPEDE.toString()) ||
                        solicitacao.getStatus().equals(Solicitacao.Status.NEGADO.toString())
                )
