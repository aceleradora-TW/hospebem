...
public class SolicitacaoControllerTest {
    ...
    public void deveSalvarSolicitacaoNoBanco() {
        ...
        Solicitacao solicitacao = new Solicitacao("oi","f","pendente","123456789","sim","46",dataNascimento,dataEntrada,dataSaida,dataTransplante,end,"kdfd",acompanhantes, "coração");
